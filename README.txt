...
I have created a personal homepage called index.html that supports two links--one to a resume (resume.html), and one to a brief biography about me (bio.html). The format and content of both have been constructed as per the specification for Lab 4 from Comp20.

--Aspects of the work that have been implemented correctly--

I have created the index.html, resume.html, and bio.html with the content and format requested in the specification.
...
I have not used styling tags, styling attributes within tags, frames, absolute URLs, front-end frameworks, JavaScript or jQuery. I have also not used other people’s CSS files, however, I did consult tutorials from W3 schools to help with different stylings. 
